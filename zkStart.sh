...
docker exec -it -u zookeeper node1 sh -c 'scp $ZOOKEEPER_HOME/../zookeeper-3.4.6-1.0.tar.gz zookeeper@node2:/home/zookeeper/soft/apache/zookeeper/'
docker exec -it -u zookeeper node1 sh -c 'scp $ZOOKEEPER_HOME/../zookeeper-3.4.6-1.0.tar.gz zookeeper@node3:/home/zookeeper/soft/apache/zookeeper/'
